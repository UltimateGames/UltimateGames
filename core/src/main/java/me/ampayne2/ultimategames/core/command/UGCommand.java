...
public abstract class UGCommand extends Command {
     ...
     */
    public UGCommand(UG ultimateGames, String name, String description, String commandUsage, Permission permission, int minArgsLength, int maxArgsLength, boolean playerOnly) {
     ...
     * @param playerOnly      If the command can only be run by a player.
     */
    public UGCommand(UG ultimateGames, String name, String description, String commandUsage, Permission permission, int exactArgsLength, boolean playerOnly) {
     ...
     * @param playerOnly    If the command can only be run by a player.
     */
    public UGCommand(UG ultimateGames, String name, String description, String commandUsage, Permission permission, boolean playerOnly) {
