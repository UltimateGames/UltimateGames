...
public class SpecialChest extends UGChest implements Listener {
    ...
    private Set<ChestAction> actions = new HashSet<ChestAction>();

    public SpecialChest(UltimateGames ultimateGames, Chest chest, Arena arena, String label, Set<ChestAction> actions) {
     ...
     */
    public SpecialChest(UltimateGames ultimateGames, Chest chest, Arena arena, String label) {
        super(chest, arena, ChestType.SPECIAL, label);
        this.ultimateGames = ultimateGames;
        ultimateGames.getServer().getPluginManager().registerEvents(this, ultimateGames);
    }
