...
public enum SignType {
    LOBBY(LobbySign.class, false), CLICK_INPUT(ClickInputSign.class, true), REDSTONE_INPUT(RedstoneInputSign.class, true), TEXT_OUTPUT(TextOutputSign.class, true), REDSTONE_OUTPUT(
            RedstoneOutputSign.class, true);
